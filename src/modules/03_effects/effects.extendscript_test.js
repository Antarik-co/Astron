...
(function () {
     ...
     * 2. Collects all effect display names from layer.property("ADBE Effect Parade").
    ...
    function saveStack(params) {
        ...
        try {
            ...
            var effectNames = [];
            var fx          = firstLayer.property("ADBE Effect Parade");
        ...
        try {
            ...
            for (var i = 0; i < layers.length; i++) {
                ...
                if (layer.property("ADBE Effect Parade") && layer.property("ADBE Effect Parade").numProperties > 0) {
                    layer.property("ADBE Effect Parade").removeAll();
                }
            }
        ...
        try {
            ...
            for (var i = 0; i < layers.length; i++) {
                ...
                try {
                    ...
                    var glowEffect = layer.property("ADBE Effect Parade").addProperty(GLOW_MATCHNAME);
