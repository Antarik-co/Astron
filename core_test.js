...
(function () {
    ...
    Astron.handle = function (messageJSON) {
        try {
            ...
            if (!msg || typeof msg.module === "undefined" || typeof msg.action === "undefined") {
                return Astron.utils.safeJSONStringify({
                    success: false,
            ...
            if (handler && typeof handler[msg.action] === "function") {
                ...
                return Astron.utils.safeJSONStringify({ success: true, data: result });
            } else {
                return Astron.utils.safeJSONStringify({
                    success: false,
            ...
            return Astron.utils.safeJSONStringify({ success: false, error: e.message });
        }
    };
     ...
     */
    Astron.utils.safeJSONParse = function(str, fallback) {
